...
urlpatterns = [
    ...
    path('snippet/<int:pk>/edit', views_cbv.SnippetUpdateView.as_view(), name="snippet-edit"),
    ...
    path('snippet/<int:snippet_id>/', views_cbv.SnippetDetailView.as_view(), name='snippet-detail'),
    # path('snippet/<int:snippet_id>/add_tag/', views.add_tag_to_snippet, name='add-tag-to-snippet'),
    path('snippet/<int:snippet_id>/add_tag/', views_cbv.AddTagToSnippetView.as_view(), name='add-tag-to-snippet'),
    path('api/simple-data/', views.simple_api_view, name='simple_api'),
    # path('notifications/', views.user_notifications, name="notifications"),
    path("notifications/", views_cbv.UserNotificationsView.as_view(), name="user_notifications"),
    ...
    path('notifications/mark_read/<int:id>/', views_cbv.UserNotificationsView.as_view(), name='mark_notification'),
    ...
    path("my-subscriptions/", views.subscriptions_page, name="my-subscriptions"),
    ...
    path("snippet/<int:snippet_id>/subscribe/", views.toggle_subscription, name="toggle_subscription"),
    # path(
